...
namespace Nemocnice.infrastructure.Migrations
{
    ...
    public partial class _8thmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "be0efcde-9d0a-461d-8eb6-444b043d6660", "Doktor", "DOKTOR" },
                    { 3, "29dafca7-cd20-4cd9-a3dd-4779d7bac3ee", "Pacient", "PACIENT" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "b09a83ae-cfd3-4ee7-97e6-fbcf0b0fe78c", "admin@admin.cz", true, "Marie", "Kučerová", true, null, "ADMIN@ADMIN.CZ", "ADMIN", "AQAAAAEAACcQAAAAEM9O98Suoh2o2JOK1ZOJScgOfQ21odn/k6EYUpGWnrbevCaBFFXrNL7JZxHNczhh/w==", null, false, "SEJEPXC646ZBNCDYSM3H5FRK5RWP2TN6", false, "admin" },
                    { 2, 0, "7a8d96fd-5918-441b-b800-cbafa99de97b", "doktor@doktor.cz", true, "Jakub", "Malý", true, null, "DOKTOR@DOKTOR.CZ", "DOKTOR", "AQAAAAEAACcQAAAAEOzeajp5etRMZn7TWj9lhDMJ2GSNTtljLWVIWivadWXNMz8hj6mZ9iDR+alfEUHEMQ==", null, false, "MAJXOSATJKOEM4YFF32Y5G2XPR5OFEL6", false, "doktor" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Heslo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Jmeno = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Prijmeni = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                table: "Doktor",
                columns: new[] { "Id", "Titul", "TitulID", "UserRoleID" },
                values: new object[] { 1, "MUDr", 0, 3 });
