...
namespace Nemocnice.Infrastructure.Database.Seeding
{
    internal class LekarskaZpravaInit
    {
        public IList<LekarskaZprava> GetLekarskaZprava()
        {
            ...
            lekarskaZprava.Add(new LekarskaZprava() { Id = 1, Zprava = "Pacient vykazuje známky zlepšení, doporučeno pokračovat v současné léčbě, kontrola za 14 dní.", Datum = DateTime.ParseExact("10-02-2025 1400", "dd-MM-yyyy HHmm", System.Globalization.CultureInfo.InvariantCulture), KartaID = 3 });
