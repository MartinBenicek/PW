...
namespace Nemocnice.application.Implementation
{
    public class DoktorService : IDoktorService
    {
        ...
        public DoktorService(ILekarskeSluzbyService lekarskeSluzbyService, IOrdinaceService ordinaceService, ILekarskaZpravaService lekarskaZprava, IPredpisService predpisService)
        {
